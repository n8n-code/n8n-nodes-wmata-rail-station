...
export class WmataRailStationApi implements ICredentialType {
	name = 'N8nDevWmataRailStationApi';

	displayName = 'wmata-rail-station API';

	icon: Icon = { light: 'file:../nodes/WmataRailStation/wmata-rail-station.png', dark: 'file:../nodes/WmataRailStation/wmata-rail-station.dark.png' };
	...
	properties: INodeProperties[] = [
		{
			...
			description: 'The base URL of your wmata-rail-station API server',
		},
		{
			displayName: 'API Key',
			name: 'apiKey',
